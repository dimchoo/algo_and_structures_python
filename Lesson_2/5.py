...
# По Вашим рекомендациям на веббинаре сделал со словарем. Выше оставил пример как достать словарь ASCII.


def get_ascii(start_el, last_el):
    ascii_dict = {
        '0': '\x00', '1': '\x01', '2': '\x02', '3': '\x03', '4': '\x04', '5': '\x05',
        '6': '\x06', '7': '\x07', '8': '\x08', '9': '\t', '10': '\n', '11': '\x0b',
        '12': '\x0c', '13': '\r', '14': '\x0e', '15': '\x0f', '16': '\x10', '17': '\x11',
        ...
        '125': '}', '126': '~', '127': '\x7f', '128': '\x80', '129': '\x81', '130': '\x82', '131': '\x83',
        '132': '\x84', '133': '\x85', '134': '\x86', '135': '\x87', '136': '\x88', '137': '\x89',
        '138': '\x8a', '139': '\x8b', '140': '\x8c', '141': '\x8d', '142': '\x8e', '143': '\x8f',
        '144': '\x90', '145': '\x91', '146': '\x92', '147': '\x93', '148': '\x94', '149': '\x95',
        '150': '\x96', '151': '\x97', '152': '\x98', '153': '\x99', '154': '\x9a', '155': '\x9b',
        '156': '\x9c', '157': '\x9d', '158': '\x9e', '159': '\x9f', '160': '\xa0', '161': '¡',
        '162': '¢', '163': '£', '164': '¤', '165': '¥', '166': '¦', '167': '§', '168': '¨',
        '169': '©', '170': 'ª', '171': '«', '172': '¬', '173': '\xad', '174': '®', '175': '¯',
    ...
    for key, val in ascii_dict.items():
        if start_el <= int(key) <= last_el:
            if int(key) == start_el + (10 - 1):
